...
- `Movements`: delivery phases and major platform modules
- `Sections`: deployable services (API, indexer, validator, ledger-writer)
...
- `Harmony`: swap/trade interface
- `Liquidity`: add/remove LP interface
- `Pools`: pool explorer and pair statistics
- `Ledger`: fee/gas/double-entry accounting views
- `Analytics`: OLAP charts and aggregations
